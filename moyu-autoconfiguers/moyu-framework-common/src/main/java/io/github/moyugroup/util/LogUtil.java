...
public class LogUtil {
    ...
    /**
     * 打印格式化控制台日志
     * 格式：IP地址|httpMethod|错误码|请求地址|是否成功|响应耗时|类名|方法名|参数|返回值|错误日志
     *
     * @param log        控制台日志对象
     * @param flag       是否成功
     * @param ip         IP地址
     ...
     * @param level      日志等级
     */
    public static void printConsoleLog(Logger log, Boolean flag, String ip, String httpMethod, String errCode, String requestUri, Long ms, String className, String methodName, String param, String resultStr, String errMsg, ExceptionLevel level) {
        String logInfo = StrUtil.format("{}|{}|{}|RequestUri:{}|{}|{}ms|{}|{}|Param:{}|Result:{}|{}",
                ip, httpMethod, errCode, requestUri, flag, ms, className, methodName, param, resultStr, errMsg);
        printLogWithLevel(log, level, logInfo);
    }

    /**
     * 打印格式化的监控日志
     * 格式：AppName|类名|方法名|真实IP|httpMethod|错误码|请求地址|是否成功|响应耗时|请求参数|返回值|错误日志
     ...
     * @param level      日志等级
     */
    public static void printMonitorLog(String className, String methodName, String ip, String httpMethod, String errorCode, String requestUri, Boolean isSuccess, Long ms,
                                       String methodArgs, String response, String errorMsg, ExceptionLevel level) {
        String appName = PropertyUtil.getProperty(CommonConstants.PROJECT_NAME, String.class, null);
        String logInfo = StrUtil.format("{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}|{}",
                appName, className, methodName, ip, httpMethod, errorCode, requestUri, isSuccess, ms, methodArgs, response, errorMsg);
        printLogWithLevel(log, level, logInfo);
    }
